...
function Settings() {
  ...
  return (
    <div className="px-2 h-full w-full  relative">
      ...
      <div className="bg-white dark:bg-[#0E1012] w-full max-w-2xl rounded-xl p-6 shadow-lg">
        <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-6 border-b pb-3">
          Profile Information
        </h3>
