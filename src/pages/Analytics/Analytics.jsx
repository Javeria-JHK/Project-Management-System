...
const quickStats = [
  ...
  { label: "Completed Tasks", value: 8, icon: TaskAltIcon },
  { label: "Active Tasks", value: 12, icon: AssignmentIndIcon },

  { label: "My Tasks", value: 2, icon: PlaylistAddCheckRoundedIcon },
  { label: "Members", value: 9, icon: GroupIcon },
];
  ...
  return (
    <div className="w-full text-gray-800">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex pr-20">List of Tasks</div>
      </div>
    </div>
  );
}
